...
public class GraphQLParserDefinition implements ParserDefinition{
    ...
    public static final TokenSet COMMENTS = TokenSet.create(new GraphQLElementType("COMMENT"));

    public static final IFileElementType FILE = new IFileElementType(
            Language.<GraphQLLanguage>findInstance(GraphQLLanguage.class));
    ...
    public PsiElement createElement(ASTNode node) {
        return GraphQLTypes.Factory.createElement(node);
    }
}